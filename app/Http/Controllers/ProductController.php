...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('photo')) {
            ...
            // $requestData['photo'] = url(Storage::url($requestData['photo']));

            // s3
            $requestData['photo'] = $request->file('photo')->store('thungsong/uploads','s3');
            $requestData['photo'] = env('AWS_URL')."/".$requestData['photo'];
        }
