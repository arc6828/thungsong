                    ...
                    <div class="card shadow-sm border-soft mt-1">
                        ...
                        <header class="card-header bg-white p-3 text-center">
                            ...
                            <span class="d-block">
                                <span class="display-1 text-dark font-weight-bold">
                                    <span class="align-top font-medium">$</span>59
                                </span>
                            </span>
                        </header>
                        <!-- End Header -->
                        ...
                        <div class="card-body">
                            <ul class="list-group mb-4">
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-success"></i> Single
                                    website for client</li>
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-success"></i> Single
                                    personal website</li>
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-success"></i> 6
                                    months friendly support</li>
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-success"></i> Future
                                    updates</li>
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-success"></i> Money
                                    back guarantee</li>
                                <li class="list-group-item"><i class="fas fa-times-circle mr-1 text-danger"></i>
                                    Multiple personal websites</li>
                                <li class="list-group-item"><i class="fas fa-times-circle mr-1 text-danger"></i>
                ...
                <div class="pricing-card">
                    <div class="card shadow-sm border-soft mt-1">
                        ...
                        <header class="card-header bg-white p-3 text-center">
                            ...
                            <span class="d-block">
                                <span class="display-1 text-dark font-weight-bold">
                                    <span class="align-top font-medium">$</span>99
                                </span>
                            </span>
                        </header>
                        <!-- End Header -->
                        ...
                        <div class="card-body">
                            <ul class="list-group mb-4">
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-secondary"></i>
                                    Single website for client</li>
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-secondary"></i>
                                    Single personal website</li>
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-secondary"></i> 6
                                    months friendly support</li>
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-secondary"></i>
                                    Future updates</li>
                                <li class="list-group-item"><i class="fas fa-check-circle mr-1 text-secondary"></i>
