        ...
        <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg @classes headroom py-lg-2 px-lg-6">
            <div class="container">
                <a class="navbar-brand" href="{{ asset ('leaf/index.html') }}">
                    ...
                    <img class="navbar-brand-light" src="{{ asset ('leaf/asset/img/brand/primary.svg') }}" alt="Logo dark">
                </a>
                        ...
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="{{ asset ('leaf/index.html') }}">
                                    <img src="{{ asset ('leaf/asset/img/brand/primary.svg') }}" alt="menuimage">
                                </a>
                            </div>
                    ...
                    <ul class="navbar-nav navbar-nav-hover m-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ asset ('leaf/html/pages/our-mission.html') }}" class="nav-link">
                                <span class="nav-link-inner-text">Our mission</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a href="{{ asset ('leaf/html/pages/about.html') }}" class="dropdown-item">About</a></li>
                                <li class="nav-item"><a href="{{ asset ('leaf/html/pages/our-mission.html') }}" class="dropdown-item">Our Mission</a></li>
                                <li class="nav-item"><a href="{{ asset ('leaf/html/pages/donate.html') }}" class="dropdown-item">Donate</a></li>
                                <li class="nav-item"><a href="{{ asset ('leaf/html/pages/updates.html') }}" class="dropdown-item">Updates</a></li>
                                <li class="nav-item"><a href="{{ asset ('leaf/html/pages/update.html') }}" class="dropdown-item">Update Single</a></li>
                                <li class="nav-item"><a href="{{ asset ('leaf/html/pages/contact.html') }}" class="dropdown-item">Contact</a></li>
                                ...
                                <li class="dropdown-submenu">
                                    <a href="#" class="dropdown-toggle dropdown-item d-flex justify-content-between align-items-center"
                                        aria-haspopup="true" aria-expanded="false">Special<i
                                            class="fas fa-angle-right nav-link-arrow"></i></a>
                                    <ul class="dropdown-menu">
                                        <li>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg">
                                <div class="col-auto px-0" data-dropdown-content>
                                    <div class="list-group list-group-flush">
                                        <a href="{{ asset ('leaf/docs/introduction.html') }}"  class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
