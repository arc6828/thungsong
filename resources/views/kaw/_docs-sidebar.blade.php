...
<!-- Sidebar -->
<div id="doc-index" class="collapse col-12 col-lg-2 border-right pt-3 pt-md-3 doc-sidebar">
    <div class="mb-3 mb-md-4">
        <a href="{{ asset ('leaf/index.html') }}">
            <img src="{{ asset ('leaf/asset/img/brand/leaf-docs.svg') }}" class="mb-5 fmxw-100" alt="Documentation Leaf Logo">
        </a>
