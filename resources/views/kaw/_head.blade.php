...
<!-- Favicon -->
<link rel="apple-touch-icon" sizes="120x120" href="{{ asset ('leaf/asset/img/favicon/apple-touch-icon.png') }}">
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset ('leaf/asset/img/favicon/favicon-32x32.png') }}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset ('leaf/asset/img/favicon/favicon-16x16.png') }}">
<link rel="manifest" href="{{ asset ('leaf/asset/img/favicon/site.webmanifest') }}">
<link rel="mask-icon" href="{{ asset ('leaf/asset/img/favicon/safari-pinned-tab.svg') }}" color="#ffffff">
